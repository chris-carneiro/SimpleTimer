package net.opencurlybraces.android.projects.simpletimer;

import net.opencurlybraces.android.projects.simpletimer.ui.Chronometer;
import net.opencurlybraces.android.projects.simpletimer.util.SystemUiHider;
...
public class TimerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartStopController = (Button) findViewById(R.id.start_stop_button);
        mStartStopController.setOnTouchListener
                (mDelayHideTouchListener);
        mStartStopController.setOnClickListener(mStartStopClickListener);
    }
